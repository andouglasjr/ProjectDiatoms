...
class DiatomsNetwork(torch.nn.Module):
    ...
    def __init__(self, num_class = 3):
        ...
        self.conv1 = torch.nn.Conv2d(3, 9, kernel_size=5, stride=1, padding=0) #220
        
        self.pool = torch.nn.MaxPool2d(kernel_size=2, stride=2, padding=0) #110
        
        self.conv2 = torch.nn.Conv2d(9, 18, kernel_size=7, stride=1, padding=0) #104        
    ...
    def forward(self, x):
        ...
        return x, [first_layer, second_layer]